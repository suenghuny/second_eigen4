...
class StarCraft2Env(MultiAgentEnv):
    ...
    def get_node_feature(self, node_id):
        ...
        node_feature = np.concatenate(
            (unit_type_feats, move_avail_feats, pos_feats, health_and_shield_feats, alliance_feats))
    ...
    def get_heterogeneous_graph(self, heterogeneous):
        ...
        return node_feature, edge_index_enemy, edge_index_ally, n_agents,dead_masking
