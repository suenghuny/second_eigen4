...
def main():
    ...
    epsilon = float(os.environ.get("epsilon", 0.01))#cfg.epsilon
    min_epsilon = float(os.environ.get("min_epsilon", 0.01)) #cfg.min_epsilon
    ...
    agent.load_model("output/episode20016_t_1020025_win_0.9375.pt")
